...
- A dark desktop preference by default across Noctalia, GTK 3/4, applications
  using the desktop color-scheme portal, and Qt 5/6 through Kvantum, with
...
them on a new machine. Codex, Claude Code, Fabric, NVM, and SDKMAN use their
upstream installers; existing installations and configured candidates are
checked before rerunning. Agent and provider authentication remains interactive
on first use.
